...
This thesis presents and evaluates a modular, researcher-operated framework for adaptive reading.
...
Within the framework, four components---sensing, analysis, decision, and intervention---are implemented as separate, interchangable modules. In this desing, new interventions or decision-making, including an AI-based ones, can be integrated without modifying the rest of the framework.
When the text is adapted, the framework maintains the reader's position and records all gaze samples, decisions, and interventions, ensuring that experimentalsessions can be replayed, analyzed, and reproduced.
...
Even so, the framework shows that the adaptive reading loop can be cleanly separated under real-time conditions, and it gives future studies of reading interventions and AI-driven adaptation a solid base to build on.
