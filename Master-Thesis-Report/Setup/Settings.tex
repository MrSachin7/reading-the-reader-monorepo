...
% Captions: one step smaller than body text and italic, with a bold label
% ("Figure 5.1") so the number still stands out (supervisor feedback, meeting 2).
\captionsetup{belowskip=\parskip,aboveskip=4pt plus 1pt minus 1pt,font={small,it},labelfont={small,bf}}
