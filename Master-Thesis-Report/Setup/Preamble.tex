...
\usepackage[newfloat]{minted} % real C#/TypeScript highlighting via Pygments; needs -shell-escape (set in .latexmkrc). Provides the `listing` float.
...
\usepackage{placeins}       % \FloatBarrier: keep floats within their subsection (Ch6)
