...
\addlinespace
Codex (OpenAI) & GPT-5.5 (latest available during Feb--June 2026) & Coding assistance for the software artifact. \\
\addlinespace
Claude (Anthropic) & Opus 4.8 and Sonnet 4.6 (latest available during Feb--June 2026) & Sounding board for design trade-offs; coding assistance; LaTeX scaffolding. \\
\bottomrule
\end{tabular}
...
The accompanying software artifact (the \texttt{reading-the-reader} monorepo) was developed with GAI coding assistance, used for scaffolding, refactoring suggestions, and debugging across the React and TypeScript frontend and the C\# and .NET backend.
...
No GAI output is reproduced verbatim in the body of this thesis.
Should any direct quotation of GAI output appear, it is cited inline using the format below, naming the provider, the tool and version, and the access date.

\begin{quote}
\small
Anthropic. \textit{Claude} (Opus 4.8) [Large Language Model].
