...
NFR2 & Low Latency &
  The system shall process gaze data with sufficiently low latency for
  just-in-time intervention delivery.
  ...
  \todo{NFR2: Research acceptable gaze-to-intervention latency threshold
  from eye-tracking literature; replace \textit{sufficiently low} with a
  concrete measurable value (e.g.\ ${\leq}\,X$\,ms).} &
