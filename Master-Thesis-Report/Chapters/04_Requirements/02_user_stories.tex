...
Tab.~\ref{tab:us} presents the elicited stories.
Stories are grouped by actor and labelled for traceability.

\begingroup
\small
\begin{longtable}{@{} p{0.10\linewidth} p{0.87\linewidth} @{}}
\caption{User stories elicited through stakeholder discussions, grouped by actor.}
\label{tab:us} \\
\toprule
...
\midrule
US-R12 & As a researcher, I want to export session data in a structured format so that I can analyse gaze behaviour and intervention effects with external tools. \\[2pt]
