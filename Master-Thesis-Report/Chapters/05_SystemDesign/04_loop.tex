...
\caption[Lifecycle of a decision proposal.]{Lifecycle of a decision proposal: every proposal enters a pending state and resolves into exactly one terminal outcome, via researcher approval (advisory) or direct application (autonomous).}
