...
\caption[Consolidated design decision register.]{Consolidated design decision register. Each row shows the driver(s) served, the principal alternative considered, and the rationale; decisions are the design commitments evaluated in \cref{ch:evaluation}.}
...
\begin{table}[htbp]
\centering
\caption[Technology selection and rationale.]{Technology selection: the principal stack choices, the main alternatives considered, and the rationale, anchored to the drivers of \cref{tab:design-drivers} and the constraints of \cref{sec:constraints}.}
