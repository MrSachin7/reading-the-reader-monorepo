...
The concrete technologies named on these containers (a Next.js and React front-end, an ASP.NET Core backend) are justified, together with the alternatives considered, in \cref{subsec:technology-selection}.
