...
\todo[inline]{\S5.4 to be written. The four modules set in motion as a bounded loop; dual-channel design, latency budget, graceful degradation and checkpointing; the controlled-boundary intervention commit that preserves reading position; the tension between clean separation and runtime speed. Discharges D2, D3, D7; RQ2, RQ3.}
