...
\caption[The four-module decomposition.]{The four-module decomposition. Each concern (sensing, analysis, decision, intervention) is a port owned by the application core; concrete implementations sit outside it and depend inward on the ports (grey arrows), while the numbered navy arrows trace the order of one adaptive cycle, from sensing (1) to intervention (4).}
