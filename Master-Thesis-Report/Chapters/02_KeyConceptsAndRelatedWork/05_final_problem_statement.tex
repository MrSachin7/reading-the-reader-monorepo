...
\begin{description}
    ...
    \item[RQ3 (Context-preserving intervention).] Can typographic micro-interventions be committed at controlled boundaries so that they adapt the text while preserving the reader's context, consistent with the recovery concerns identified in the literature \cite{jensen2025context}?
