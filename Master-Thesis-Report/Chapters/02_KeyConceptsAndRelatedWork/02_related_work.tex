...
Just as consequential as their internal coupling is what these prototypes did not provide: a researcher-facing console.
None offered a way to monitor a participant's reading as it happened, to apply or vary an intervention under controlled conditions, or to capture a session as a reproducible record.
They could therefore demonstrate that gaze-driven adaptation works, but not support the controlled, repeatable study through which a researcher learns which interventions help.
Supplying that capability, rather than demonstrating adaptation once more, is the need the present work addresses.
