...
Fig.~\ref{fig:adaptive-loop} redraws the same loop as four sequential stages, sensing, analysis, decision, and intervention, whose output changes what the reader sees and so feeds the next cycle of sensing.
