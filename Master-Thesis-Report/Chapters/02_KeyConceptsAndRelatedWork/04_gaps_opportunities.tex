...
Crucially, such a provider cannot be built or trusted in a vacuum: it needs reproducible data to learn from and a live boundary at which its decisions can be applied and measured.
Defining that boundary, and recording the data that crosses it, is therefore not a step towards the AI but the groundwork the AI depends on.
