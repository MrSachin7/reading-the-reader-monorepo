...
\textbf{\cref{ch:key-concepts-related-work}} surveys the concepts and literature that underpin the work.
...
\textbf{\cref{ch:methodology}} describes how the thesis was conducted.
...
\textbf{\cref{ch:requirements}} derives the functional and non-functional requirements of the platform from stakeholder analysis and use cases.
It introduces a domain model and documents the constraints that bound the design space.

\textbf{\cref{ch:design}} presents the system architecture.
...
\textbf{\cref{ch:implementation}} describes how the architecture is realised in code.
...
\textbf{\cref{ch:evaluation}} evaluates the platform against the four research questions.
...
\textbf{\cref{ch:discussion}} interprets the evaluation results in relation to the problem statement and the literature, discusses the limitations of the current work, and outlines directions for future research.

\textbf{\cref{ch:conclusion}} summarises the contributions and answers the research questions directly.
