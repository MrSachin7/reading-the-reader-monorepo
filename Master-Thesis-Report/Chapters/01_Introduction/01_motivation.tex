...
\node[block, draw=black!15, fill=gray!5, text width=4.6cm,
      font=\normalsize, text=black!72] (before)
...
\end{tikzpicture}
\caption{An adaptive reading intervention: increased font size, line spacing, and contrast for improved readability, balancing reading support against reading flow.}
