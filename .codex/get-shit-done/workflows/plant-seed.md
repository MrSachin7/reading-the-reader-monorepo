...
```bash
node "C:/Users/s243871/reading-the-reader-monorepo/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
