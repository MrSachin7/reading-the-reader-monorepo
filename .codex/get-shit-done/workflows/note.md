...
- **Global scope**: `C:/Users/s243871/reading-the-reader-monorepo/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/s243871/reading-the-reader-monorepo/.codex/notes/`)
...
2. Glob `C:/Users/s243871/reading-the-reader-monorepo/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/s243871/reading-the-reader-monorepo/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/s243871/reading-the-reader-monorepo/.codex/notes/` — works in any directory
