...
Use template from `C:/Users/s243871/reading-the-reader-monorepo/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/s243871/reading-the-reader-monorepo/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/s243871/reading-the-reader-monorepo/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
