...
%                 150 words, 14 pages for full papers excluding references. For submission
%                 also add "anonymous" to the class options below.
...
\acmConference[Working draft]{Working draft}{September 2026}{not for distribution}
