"""Read-only audit of thesis evidence; writes only paper-astra/analysis/outputs.
...
def main():
    ...
    print(json.dumps({k:result[k] for k in ["cohort","behaviour","cohort_rtt","context_status","advisory","sweep","legacy_loader"]},indent=2))
    return result
