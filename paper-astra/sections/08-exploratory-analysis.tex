...
\begin{table}[tb]
\caption{Participant-level first-forward-movement medians (ms), with observed / applied counts in parentheses. Texts and intervention sequences differ across conditions. P3 has one missing \off{} observation.}
\label{tab:movement}
\centering
